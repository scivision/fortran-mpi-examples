...
if(MPI_C_FOUND)
  ...
  if(NOT TARGET MPI::MPI_C)
    ...
    if(MPI_C_LINK_FLAGS)
      set_property(TARGET MPI::MPI_C PROPERTY INTERFACE_LINK_OPTIONS "${MPI_C_LINK_FLAGS}")
    endif()
  endif()
endif(MPI_C_FOUND)
...
if(MPI_CXX_FOUND)
  ...
  if(NOT TARGET MPI::MPI_CXX)
    ...
    if(MPI_CXX_LINK_FLAGS)
      set_property(TARGET MPI::MPI_CXX PROPERTY INTERFACE_LINK_OPTIONS "${MPI_CXX_LINK_FLAGS}")
    endif()
  endif()
endif(MPI_CXX_FOUND)
...
if(MPI_Fortran_FOUND)
  ...
  if(NOT TARGET MPI::MPI_Fortran)
    ...
    if(MPI_Fortran_LINK_FLAGS)
      set_property(TARGET MPI::MPI_Fortran PROPERTY INTERFACE_LINK_OPTIONS "${MPI_Fortran_LINK_FLAGS}")
    endif()
  endif()
